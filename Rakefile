...
production_url = "http://www.moviepilot-less-test.net/"
production_path = "/home/web/hagenburger/PREVIEW/moviepilot-less-test"
...
task :build do
  ...
  css = File.read('build/stylesheets/moviepilot-less-test.css')
  File.open('build/stylesheets/moviepilot-less-test.css', 'w') do |file|
